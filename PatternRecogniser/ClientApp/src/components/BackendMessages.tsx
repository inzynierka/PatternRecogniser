export enum TrainModelMessages {
    modelAlreadyExist = "Model już istnieje",
    incorectFileFormat = "Zły format pliku",
    youAreNotInQueue = "Nie ma cię w kolejce",
    ...
    modelNotFound = "Nie znaleziono podanego modelu"
}